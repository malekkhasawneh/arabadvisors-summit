...
class EditProfileRepository {
  ...
  static Future<List<GetAllCountryModel>> getAllCountry() async {
  ...
  static Future<List<GetAllCompanyModel>> getAllCompany() async {
    Map<String, String> requestHeaders = {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
    };
  ...
  static Future<List<GetAllIndustryModel>> getAllIndustry() async {
    Map<String, String> requestHeaders = {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
    };
